    ...
    <form action="{{ route('user.store') }}" method="POST" class="text-start">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="nama" name="nama"
                   class="form-control rounded-pill p-3 border-0"
        ...
        <div class="mb-3">
            ...
            <input type="text" id="npm" name="npm"
                   class="form-control rounded-pill p-3 border-0"
                   placeholder="Masukkan NPM kamu..." required>
        </div>
            ...
            <div class="bg-light text-dark p-3 rounded-4">
                @foreach ($kelas as $kelasItem)
                    <div class="form-check mb-2">
                        <input class="form-check-input" type="radio" name="kelas_id" id="kelas{{ $kelasItem->id }}" value="{{ $kelasItem->id }}" required>
        ...
        <button type="submit"
                class="btn btn-light fw-bold px-5 py-2 rounded-pill shadow">
            💾 Simpan
        </button>
    </form>
</div>
